        ...
        function n(t, e, i, n, o,pagemode) {
            ...
            e.eachChild(function (l, u) {
                ...
                if ("horizontal" === t) {
                    ...
                    if(pagemode){
                        if(c > o || l.newline){
                            var html = '<div class="js-prePage"><img style="width: 32px;height: 32px;cursor: no-drop" src="../../../assets/plugin/echarts/img/up-disable.png"  title="已经是第一页"/></div>';
                            html +=	'<div class="js-nextPage"><img  style="width: 32px;height: 32px;cursor: pointer" src="../../../assets/plugin/echarts/img/down-icon.png" title="下一页"/></div>';
